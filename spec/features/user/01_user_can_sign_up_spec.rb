...
feature 'user is able to' do
  ...
  let!(:test_user) {User.create!(email: "test_user@mail.com", password: "password", username: "test_user_2", first_name: "test", last_name: "user")}
  ...
  scenario 'is unable to use an already excisting username' do 
    visit new_user_registration_path
